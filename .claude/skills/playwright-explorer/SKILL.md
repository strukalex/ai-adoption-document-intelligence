...
2. Extract all page references and user flows from test plans
...
## Workflow
Work through pages systematically:
...
5. Document changes in selector-changes.md
6. Create page-doc.md and selectors.md
7. Confirm with user before proceeding to next page
