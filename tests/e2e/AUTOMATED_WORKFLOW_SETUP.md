...
**Output**:
- `{feature}/playwright/test-plans.md` with Given/When/Then scenarios
...
#### `/playwright-explorer`
**Purpose**: Explores the application with Playwright and documents pages
...
- Screenshots in `playwright/screenshots/`
...
# Review the generated test plan at:
# feature-docs/003-benchmarking-system/playwright/test-plans.md

# Step 2: Explore
# IMPORTANT: Start your application first!
npm run dev

# Then explore and document the app
/playwright-explorer feature-docs/003-benchmarking-system/

# This will interactively explore each page, taking screenshots
...
│   └── US-002.md
└── playwright/
    ├── test-plans.md        # Generated by /test-planner
